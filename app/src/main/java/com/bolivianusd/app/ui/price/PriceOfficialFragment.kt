...
import com.bolivianusd.app.databinding.FragmentPriceOfficialBinding
...
class PriceOfficialFragment : Fragment() {

    private lateinit var binding: FragmentPriceOfficialBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPriceOfficialBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
        const val TAG = "PriceOfficialFragment"
        fun newInstance() = PriceOfficialFragment()
    }
